...
export default function DreamMapClient({
  ...
  const handleTagClick = (tagId: string, tagLabel: string) => {
    if (selectedTag === tagId) {
      ...
      // - Navigate to a filtered dream list
      // - Show a modal with tag details
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      {/* Dreamy title with floating effect */}
      <motion.h1 
      ...
      >
        Where your subconscious thoughts dance in the void
      </motion.p>
        ...
        >
          <div className="text-center">
            ...
            <p className="text-xs text-gray-400">
              Click to explore dreams with this theme
            </p>
            <button
      ...
      {nodes.length === 0 ? (
        <div className="flex items-center justify-center h-screen">
          ...
          >
            ...
            <p className="text-cyan-300 text-xl mb-4 font-medium">The dream realm awaits...</p>
            <p className="text-cyan-200/70 text-sm mb-8 max-w-md">
              Your subconscious mind is empty. Record your first dream to see the cosmic dance of thoughts and emotions unfold.
            </p>
            <motion.a 
              href="/dreams/new" 
