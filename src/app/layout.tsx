...
// Using system monospace font as fallback due to network restrictions
// In production with proper network access, you can restore:
// import { Spline_Sans_Mono } from "next/font/google";
// const splineSansMono = Spline_Sans_Mono({ subsets: ["latin"], variable: "--font-spline-mono", display: "swap" });

export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <Providers>
        <body className={`relative min-h-screen overflow-x-hidden bg-gradient-to-b from-[#060312] via-[#0a0621] to-[#0d0838] text-gray-100 selection:bg-fuchsia-600/30 selection:text-fuchsia-100 font-mono`}>
