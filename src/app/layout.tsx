...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <Providers>
      <body className="relative min-h-screen text-gray-100 overflow-hidden bg-gradient-to-b from-[#060312] via-[#0a0621] to-[#0d0838] selection:bg-fuchsia-600/30 selection:text-fuchsia-100">
